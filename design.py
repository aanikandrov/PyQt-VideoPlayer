...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_ThreadPool_pushPlay.setGeometry(QtCore.QRect(300, 30, 70, 25))
        ...
        self.tab_ThreadPool_pushPause.setGeometry(QtCore.QRect(300, 60, 50, 25))
        ...
        self.tab_ThreadPool_radioCamera.setGeometry(QtCore.QRect(300, 90, 70, 25))
        ...
        self.tab_ThreadPool_radioFile.setGeometry(QtCore.QRect(300, 120, 70, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tab_ThreadPool_pushPlay.setText(_translate("MainWindow", "Play/Restart"))
        ...
        self.tabVideo.setTabText(self.tabVideo.indexOf(self.tab_ThreadPool), _translate("MainWindow", "QThreadPool"))
    ...
    def video_tab_ThreadPool(self, MainWindow):
        ...
        self.tab_ThreadPool_radioCamera.clicked.connect(self.change_mode)
        self.tab_ThreadPool_radioFile.clicked.connect(self.change_mode)
    ...
    def change_mode(self):
        if self.tab_ThreadPool_radioCamera.isChecked():
            ...
            self.tab_ThreadPool_pushPlay.clicked.connect(self.start_file)
